...
public class RecipeBook {
    ...
    public RecipeBook(){
        ...
        recipeBook.put(1, new Recipe("Яичница", 10, new ArrayList<>(List.of(new Ingredient("Яйца", 3, "шт"),
                ...
                new Ingredient("Масло растительное", 2, "Чайных ложки"))), new LinkedList<>(List.of("Выливаем масло на сковороду", "Разогреваем сковородку","Жарим яйца", "Добавляем колбасу", "Добавляем соль и специи по вкусу","Шарим 5 минут","Готовим до готовности" ))));
    }
